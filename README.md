...
1. [Скачай и установи](https://nodejs.org/en/) **`Версию Node 10.16.3`**:
2. Выполни в консоли **`node -v`** и убедись, что установленная версия **`Node.js`**: **`10.16.3`**;
3. Выполни в консоли **`npm -v`** и убедись, что установленная версия **`npm`**: **`6.9.0`**;
